export const anilProfile = {
  ...
  summary: "Senior DevOps Engineer with 8+ years of IT experience and 5+ years specializing in Cloud Infrastructure, Platform Engineering, Kubernetes, CI/CD Automation, Site Reliability Engineering, and Cloud-Native Technologies.",
};
...
export const anilTimeline = [
  {
    ...
    summaryPoints: [
      ...
      "Built observability solutions using Prometheus, Grafana, Azure Monitor, and Log Analytics to improve system visibility and incident response.",
  ...
  },
  {
    ...
    summaryPoints: [
      ...
      "Worked on monitoring, troubleshooting, and optimizing GKE (GCP) workloads by integrating logging, monitoring, and CI/CD pipelines.",
      "Created and maintained Infrastructure as Code (IaC) using Terraform with reusable modules for Kubernetes clusters, networking, storage, and identity management.",
...
export const anilProjects = [
  {
    ...
    description: "Migrated legacy on-premise middleware platforms into Azure Kubernetes Service. Designed deployment architecture for RabbitMQ, ActiveMQ Artemis, MinIO, Couchbase, and Memcached. Implemented secure secret management using Azure Key Vault and Workload Identity.",
  ...
  },
  {
    ...
    description: "Implemented GitOps workflows using ArgoCD to standardize deployment processes across multiple engineering teams. Created reusable templates, automation scripts, and developer onboarding documentation.",
  ...
  },
  {
    ...
    description: "Implemented comprehensive monitoring, alerting, incident response, RCA, and runbooks using Prometheus, Grafana, Azure Monitor, Elasticsearch, and Log Analytics.",
...
export const anilProfileBanner = {
  ...
  profileSummary: "Google Cloud Certified - Professional Cloud DevOps Engineer | Senior DevOps Engineer with 8+ years of experience across Azure, GCP, and cloud-native platforms.",
};
