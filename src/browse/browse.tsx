...
const Browse: React.FC = () => {
  ...
  const profiles = [
    ...
    },
    {
      name: "stalker",
      image: redImage,
      backgroundGif: "https://i.giphy.com/media/v1.Y2lkPTc5MGI3NjExc28yMjMyZmJ6eWtxbmNwdDV6cXk4dWZmcjFhZms2cXBjN2h5ZDJjeSZlcD12MV9pbnRlcm5hbF9naWQmY3Q9Zw/QjZXUBUr89CkiWLPjL/giphy.gif"
    },
    {
      name: "adventurer",
      image: yellowImage,
